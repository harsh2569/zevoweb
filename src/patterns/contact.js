    ...
    return (
        ...
        <div className="contact">
            ...
            <div className="input-group">
                My &nbsp; name &nbsp; is 
                <input type="text" placeholder="Eg. Esther Howard" name="username" value={formData.username} onChange={handleChange} />. 
                I &nbsp; Work &nbsp; as &nbsp; a
                 <input type="text" placeholder="Eg. Cheif Technical Officer" name="work"  value={formData.work} onChange={handleChange}  />
                 &nbsp; at 
                 <input type="text" placeholder="Eg. Antus Data Labs, USA" name="place"  value={formData.place} onChange={handleChange} />
               We &nbsp; have &nbsp; a &nbsp; budget &nbsp; of &nbsp; around 
                <input type="number" placeholder="Enter your estimated budget" name="amount"  value={formData.amount} onChange={handleChange} />
                to &nbsp; complete &nbsp; a
                 <select name="category"  value={formData.category} onChange={handleChange}>
                     <option value="" disabled  hidden>Select a project category</option>
                     <option value="UI | UX Designing">UI | UX Designing</option>
                     <option value="Hybrid App Development">Hybrid App Development</option> 
                     <option value="Progressive Web App Development">Progressive Web App Development</option>
                     <option value="Landing Page Development">Landing Page Development</option>
                     <option value="Minimum Viable Product Development">Minimum Viable Product Development</option>
                     <option value="Blockchain Core Development">Blockchain Core Development</option>
                     <option value="Smart Contract Development">Smart Contract Development</option>
                     <option value="Defi / Dapp / NFT Development">Defi / Dapp / NFT Development</option>
                     <option value="Web3 / Ethers Integration">Web3 / Ethers Integration</option>
                     <option value="Dapp Architechting">Dapp Architechting</option>
                </select> 
                 on &nbsp; or &nbsp; around &nbsp; a
                <input type="text" placeholder="Eg. 2 months from now" name="duration"  value={formData.duration} onChange={handleChange} />
                .&nbsp;You &nbsp; can &nbsp; reach &nbsp; me &nbsp; at
                <input type="text" placeholder="Eg. estherhoward@example.com" name="email"  value={formData.email} onChange={handleChange} /> 
                or &nbsp; at 
                <select>
                    <option value="" disabled selected hidden>91</option>
                </select>
                <input type="number" placeholder="Eg. 7789654123" name="mobileno"  value={formData.mobileno} onChange={handleChange} />
            </div>
